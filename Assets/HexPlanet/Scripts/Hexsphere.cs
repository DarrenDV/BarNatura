...
public class Hexsphere : MonoBehaviour {
	...
	public void generateRandomRegions(){
        ...
        for (int i = 0; i < tiles.Count; i++) {
			int col = UnityEngine.Random.Range(0, GroupMaterials.Length);
        ...
        */
        ...
        if (detailLevel == 3 || detailLevel == 4)
        {
            ...
            for(int i = 0; i < tiles.Count; i++)
            {
                if (tiles[i].GroupID == 0)
                {
                    tiles[i].SetExtrusionHeight(0f);
                }
                if (tiles[i].GroupID == 1)
                {
                    for(int j = 0; j < tiles[i].neighborTiles.Count; j++)
                    {
                    ...
                    tiles[i].SetExtrusionHeight(0.02f);
                }
                if (tiles[i].GroupID == 3)
                {
                    for (int j = 0; j < tiles[i].neighborTiles.Count; j++)
                    {
                        if (tiles[i].neighborTiles[j].GroupID == 0)
                    ...
                    tiles[i].SetExtrusionHeight(0.01f);
                }
